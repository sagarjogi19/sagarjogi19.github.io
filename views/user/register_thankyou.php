            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="thankUBox">
                        ...
                        <p class="thankyouText">Congratulations! Your account has been registered successfully.</p>
                        <br>
                        <p>You will be redirect to the login page in <span id="timecount">10</span> seconds.</p>
