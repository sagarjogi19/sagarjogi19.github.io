                        ...
                        <div class="dTabCon"> 
                            <div class="">
                                ...
                                <div class="teamHeader">
                                    ...
                                    <div class="S_addNew"> 
                                        <a href="<?php echo setLink('user/user_add'); ?>" title="Add New" class="btn skyBlueBtn">Add New</a>
                                    </div>
                                </div>
                                        ...
                                        <table id="tableData" class="table table-bordered table-striped custom-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th aria-sort="desc" data-title="business_name" class="is-active sortOrder">Business Name</th> 
                                                    <th aria-sort="desc" data-title="username" class="is-active sortOrder">User Name</th> 
