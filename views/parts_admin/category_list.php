                        ...
                        <div class="dTabCon"> 
                            <div class="">
                                ...
                                <div class="teamHeader">
                                    ...
                                    <div class="S_addNew"> 
                                        <a href="<?php echo setLink('user/parts/category_add'); ?>" title="Add New" class="btn skyBlueBtn">Add New</a>
                                    </div>
                                </div>
                                        ...
                                        <table id="tableData" class="table table-bordered table-striped custom-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th aria-sort="desc" data-title="category_name" class="is-active sortOrder">Category Name</th>
                                                    <th aria-sort="desc" data-title="parent_category" class="is-active sortOrder">Parent Category</th> 
